    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="form-group col-md-2">
                    <input type="text" name="paid" id="pay_paid" class="form-control custom-text" placeholder="Pay remaining amount *" onkeyup="arrearsDuePaidChange()" pattern="[0-9]{1,9}" autofocus required>
                </div>
            </div>
        </div>
        <div class="col-md-12">
